...
class BookDataSource: NSObject {
    ...
    class func bookList() -> [Book] {
        let bookList = [
            ...
            Book(type: "intent", name: "The Monstrumologist", details: "The Monstrumologist (2009) is a young adult horror novel by Rick Yancey. It received the 2010 Michael L. Printz Honor Award for excellence in young adult literature.", buttonsAttibutes: [ButtonAtributes(title: "boton 1", message: "hola mundo!"),ButtonAtributes(title: "boton 2", message: "hola mundo!"),ButtonAtributes(title: "boton 3", message: "hola mundo!"),ButtonAtributes(title: "boton 4", message: "hola mundo!")]),
